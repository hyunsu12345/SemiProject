...
<body>
	...
	<div class="container custom-container">
		...
		<fieldset>	
			<form action="{ contextPath }/insertQA.bo" method="post">
				<div class="row">	
					<div class="col-md-2">
						<label>문의유형</label>	
					</div>
				...
				<div class="row">
					...
					<div class="col-md-10">
						<select id="questionOptions" required onchange="handleSelectChange()">
					 		<option value="">문의 유형을 선택해주세요.</option>
						</select>	
					</div>
				</div><br><hr style="border-color: dimgrey; height:2px;">
				<div class="row">
					...
					<div class="col-md-10 input-group mb-3" id="orderNumberDiv" style="margin-top:13px;">
      					<input type="text" class="form-control" id="orderNumber" name="orderNumber" aria-label="Recipient's username" aria-describedby="button-addon2" readonly>
				...
				<div class="row">
					...
					<div class="col-md-10">
						<input type="text" id="writer" name="writer" value="박현수" required>
					</div>
				</div><hr style="border-color: dimgrey; height:2px;">
				<div class="row">
					<div class="col-md-1">
					...
					<div class="col-md-10">
						<input type="text" id="phone" name="phone"  value="010-4513-8586" required>
					</div>
				</div><hr style="border-color: dimgrey; height:2px;">
				<div class="row">
					<div class="col-md-1">
					...
					<div class="col-md-10">
						<input type="email" id="email" name="email" value="hyunsuddong@naver.com" required>
					</div>
				</div><hr style="border-color: dimgrey; height:2px;">
				<div class="row">
					<div class="col-md-1">
					...
					<div class="col-md-10">
						<input type="text" id="subject" name="subject" maxlength="90" required>
					</div>
				</div><hr style="border-color: dimgrey; height:2px;">
				<div class="row">
					<div class="col-md-1">
